...
build-magisk: build-arm64 build-armv7
	...
	@rm -f bin/ZenGoBox-Magisk-v1.0.7.zip
	...
	@cd bin/magisk-temp && zip -r9 ../ZenGoBox-Magisk-v1.0.7.zip .
	@rm -rf bin/magisk-temp
	@echo "Magisk Module ZIP created at bin/ZenGoBox-Magisk-v1.0.7.zip"
